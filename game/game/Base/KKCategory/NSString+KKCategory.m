...
- (BOOL)isPhoneNumber
{
    ...
    //             * 移动号段正则表达式
    //             */
//    NSString * CM_NUM = @"^((13[4-9])|(147)|(148)|(15[0-2,7-9])|(178)|(198)|(18[2-4,7-8]))\\d{8}|((1703)|(1705)|(1706)|(1440))\\d{7}$";
    //            /**
    //             * 联通号段正则表达式
    //             */
//    NSString *CU_NUM = @"^((13[0-2])|(145)|(146)|(166)|(15[5-6])|(175)|(176)|(18[5,6]))\\d{8}|(170[7-9])\\d{7}$";
    //            /**
    //             * 电信号段正则表达式
    //             */
//    NSString *CT_NUM = @"^((133)|(153)|(177)|(173)|(149)|(199)|(18[0,1,9]))\\d{8}|((170[0-2])|1349|1410)\\d{7}$";
