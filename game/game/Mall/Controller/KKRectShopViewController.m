...
#import "Masonry.h"
@interface KKRectShopViewController ()<UICollectionViewDelegate,UICollectionViewDataSource>
@property (nonatomic,strong) UICollectionView * cv;
@end

@implementation KKRectShopViewController
...
-(UICollectionView *)cv
{
    if (_cv == nil) {
        ...
        [_cv registerClass:[KKSmallMallShopCollectionViewCell class] forCellWithReuseIdentifier:@"rectShop"];
        _cv.delegate = self;
        _cv.dataSource = self;
...
{
    KKSmallMallShopCollectionViewCell * cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"rectShop" forIndexPath:indexPath];
    cell.showRight = YES;
