...
- (UIButton *)previewBtn {
    if (!_previewBtn) {
        ...
        [leftBtn setTitleColor:kThemeColor forState:UIControlStateNormal];
...
//    toorBar.barStyle = UIBarStyleBlackTranslucent;
    ...
    NSString * btm = isIphoneX?@"34":@"0";
    NSString *heightVfl = [NSString stringWithFormat:@"V:[toorBar(44)]-%@-|",btm];
